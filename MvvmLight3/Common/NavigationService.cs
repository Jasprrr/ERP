...
namespace MvvmLight3.Common
{
    ...
    public class NavigationService : ViewModelBase
    {
        ...
        /// </summary>
        public Type RootPageType => typeof(MainWindow);

        /// <summary>
        /// Gets the current page type from the navigation frame.
        /// </summary>
       //'public Type CurrentPageType => this.NavigationFrame.Source.t;
        ...
        {
            this.CanGoBack = this.NavigationFrame.CanGoBack;
        }
    }
}
